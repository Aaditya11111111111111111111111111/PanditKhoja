      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="flex bg-gray-100 rounded-full p-0.5">
              <button
                ...
                className={`px-3 py-1 rounded-full text-xs font-semibold transition ${
                  lang === "en" ? "bg-white text-violet-700 shadow-sm" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                EN
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-full text-xs font-semibold transition ${
                  lang === "np" ? "bg-white text-violet-700 shadow-sm" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                नेपाली
              </button>
            ...
            <button className="px-5 py-2 rounded-full bg-violet-700 text-white font-medium hover:bg-violet-800 transition cursor-pointer text-sm">
            ...
            <div className="flex bg-gray-100 rounded-full p-0.5">
              <button
                ...
                className={`px-2.5 py-0.5 rounded-full text-xs font-semibold transition ${
                  lang === "en" ? "bg-white text-violet-700 shadow-sm" : "text-gray-500"
                }`}
              >
                EN
              </button>
              <button
                onClick={() => lang !== "np" && toggleLang()}
                className={`px-2.5 py-0.5 rounded-full text-xs font-semibold transition ${
                  lang === "np" ? "bg-white text-violet-700 shadow-sm" : "text-gray-500"
                }`}
              >
                नेपाली
              </button>
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-6 py-4 flex flex-col gap-1">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <button className="w-full px-5 py-2.5 rounded-full bg-violet-700 text-white font-medium hover:bg-violet-800 transition cursor-pointer text-sm">
              {t.nav.becomePandit[lang]}
            </button>
          </div>
        </div>
