      ...
      <Container className="relative z-10 py-8 sm:py-16 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-6 sm:mt-10 flex flex-row justify-center gap-3">
            <button className="px-5 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-medium text-sm sm:text-base bg-violet-700 text-white hover:bg-violet-800 transition cursor-pointer">
              {h.btn1[lang]}
            </button>
            <button className="px-5 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-medium text-sm sm:text-base border border-gray-300 text-gray-200 hover:bg-white/10 transition cursor-pointer">
              {h.btn2[lang]}
            </button>
          </div>
